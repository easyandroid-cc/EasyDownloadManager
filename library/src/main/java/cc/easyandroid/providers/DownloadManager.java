...
public class DownloadManager {
    ...
    public static final Set<String> LONG_COLUMNS = new HashSet<String>(
...
//            }
        ...
        ContentValues toContentValues(String packageName) {
            ...
            //cgp 20140519  增加一个id
            putIfNonZero(values, BaseColumns._ID, mId);
         ...
         * @param value
         */
        private void putIfNonZero(ContentValues contentValues, String key,
                                  long value) {
            if (value != 0) {
    ...
    private Uri mBaseUri = DownloadPros.CONTENT_URI;
    ...
    public void setAccessAllDownloads(boolean accessAllDownloads) {
        if (accessAllDownloads) {
            mBaseUri = DownloadPros.ALL_DOWNLOADS_CONTENT_URI;
        } else {
            mBaseUri = DownloadPros.CONTENT_URI;
        }
    }
    ...
    public long enqueue(Request request) {
        ...
        Uri downloadUri = mResolver.insert(DownloadPros.CONTENT_URI, values);
