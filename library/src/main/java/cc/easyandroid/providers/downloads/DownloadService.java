...
public class DownloadService extends Service {
    ...
    public void onCreate() {
        ...
        getContentResolver().registerContentObserver(
                DownloadPros.ALL_DOWNLOADS_CONTENT_URI, true, mObserver);
    ...
    Notification buildNotification() {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            String CHANNEL_ONE_ID = "com.easyandroid.driver";
    ...
    private void updateFromProvider() {
        synchronized (this) {
            ...
            if (mUpdateThread == null) {
                ...
                mSystemFacade.startThread(mUpdateThread, false);//这里只是线程中的线程，一个文件的分片下载，所以这样要马上执行线程
            }
        }
    }
        ...
        public void run() {
            ...
            for (; ; ) {
                ...
                Cursor cursor = getContentResolver().query(
                        DownloadPros.ALL_DOWNLOADS_CONTENT_URI, null, null, null,
                        null);
                if (cursor == null) {
                    continue;
                }
