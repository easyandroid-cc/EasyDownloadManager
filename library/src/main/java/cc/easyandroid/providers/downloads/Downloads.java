 ...
 * @pending
 */
public final class Downloads implements BaseColumns {//AUTHORITY CONTENT_URI DownloadProviderPro
...
//    public static   String AUTHORITY ;//= BuildConfig.AUTHORITY + ".downloads";
     ...
     * @hide
     */
    public static final String PERMISSION_ACCESS = "cc.easyandroid.permission.ACCESS_DOWNLOAD_MANAGER";
     ...
     * @hide
     */
    public static final String PERMISSION_ACCESS_ADVANCED = "cc.easyandroid.permission.ACCESS_DOWNLOAD_MANAGER_ADVANCED";

    /**
     * The permission to access the all the downloads in the manager.
     */
    public static final String PERMISSION_ACCESS_ALL = "cc.easyandroid.permission.ACCESS_ALL_DOWNLOADS";
     ...
     * @hide
     */
    public static final String PERMISSION_SEND_INTENTS = "cc.easyandroid.permission.SEND_DOWNLOAD_COMPLETED_INTENTS";

    /**
     * The permission to download files without any system notification being
     * shown.
     */
    public static final String PERMISSION_NO_NOTIFICATION = "cc.easyandroid.permission.DOWNLOAD_WITHOUT_NOTIFICATION";
...
//    public static   Uri CONTENT_URI;//
     ...
     */
//    public static   Uri ALL_DOWNLOADS_CONTENT_URI  ;
